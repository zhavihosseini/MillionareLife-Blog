            ...
            <div class="card card-signin my-5">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-label-group">
                            <input type="email" id="email" name="email" class="form-control" placeholder="آدرس ایمیل" required autofocus style="text-align: right">
                            <label  for="email" :value="__('Email')" style="text-align: right">آدرس ایمیل خود را وارد کنید</label>
                        </div>
                        ...
                        <hr class="my-4">
                        <button class="btn btn-lg btn-google btn-block text-uppercase" type="submit" style="border-radius: 0px"><i class="fab fa-google mr-2"></i> ساخت حساب کاربری با گوگل</button>
                        <br>
                    </form>
                    <a class="btn btn-lg btn-block text-uppercase" type="submit" id="subidv" href="{{route('register')}}">قبلا ثبت نام کردید ؟ صفحه ی ورود</a>
                    <hr>
                    <a class="btn btn-lg btn-block text-uppercase" type="submit" id="subidv" href="{{route('showphone')}}">ثبت نام با شماره ی تلفن همراه</a>
                </div>
            </div>
        </div>
    </div>
