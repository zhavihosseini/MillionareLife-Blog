    ...
    <div class="row">
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            ...
            <div class="card card-signin my-5">
                <div class="card-body">
                    <h5 class="card-title text-center" style="font-family: Yekan;font-size: 28px;font-weight: normal">ورود به حساب کاربری</h5>
                    ...
                    <form class="form-signin" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-label-group" style="direction: rtl">
                            <input placeholder="یوزرنیم یا ایمیل را وارد کنید" id="username" type="text" class="form-control" name="identity" required autofocus>
                            <label  for="username" :value="__('identity')" style="text-align: right">آدرس ایمیل و یا یوزر نیم خود را وارد کنید</label>
                        </div>

                        <div class="form-label-group" style="direction: rtl">
                            <input type="password" name="password" id="password" class="form-control" placeholder="رمز عبور" required autocomplete="current-password" style="text-align: right">
                            <label for="password" style="text-align: right" :value="__('Password')">رمز عبور</label>
                        </div>
                        <div class="row">
                            <div style="text-align: right">
                                @if (Route::has('password.request'))
                                    <a class="underline text-sm text-gray-600 hover:text-gray-900" style="text-align: right" href="{{ route('password.request') }}">
                                        رمز عبور خود را فراموش کرده ایید؟
                                    </a>
                                @endif
                            </div>
                            <div class="custom-control custom-checkbox mb-3" style="text-align: right">
                                <input type="checkbox" class="custom-control-input" id="remember_me" name="remember">
                                <label class="custom-control-label" for="remember_me">من را به خاطر بسپار</label>
                            </div>
                        </div>
                        <button class="btn btn-lg btn-block text-uppercase" type="submit" id="subid">ورود به حساب کاربری</button>
                        <hr class="my-4">
                        <button class="btn btn-lg btn-google btn-block text-uppercase" type="submit" style="border-radius: 0px"><i class="fab fa-google mr-2"></i> ورود با حساب گوگل</button>
                        <br>
                    </form>
                    <a class="btn btn-lg btn-block text-uppercase" type="submit" id="subidv" href="{{route('register')}}">حساب کاربری ندارید ؟ ساخت حساب کاربری</a>
                </div>
            </div>
        </div>
    </div>
