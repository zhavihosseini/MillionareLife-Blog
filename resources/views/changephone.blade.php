            ...
            <div class="card card-signin my-5">
                <div class="card-body">
                    ...
                    @if(session('err'))
                        ...
                        <br>
                    @endif
                    <form method="post" action="<?php echo route('changesphone')?>">
                        @csrf
                        <div class="form-label-group">
                            <input type="text" id="phone" name="phone" class="form-control" placeholder="شماره تلفن همراه خود را وارد کنید" required autofocus style="text-align: right">
                            <label  for="phone" :value="__('phone')" style="text-align: right">شماره تلفن همراه خود را وارد کنید</label>
                        </div>
                        <button class="btn btn-lg btn-block text-uppercase" type="submit" id="subid">تعویض شماره همراه</button>
                    </form>
                </div>
            </div>
        </div>
