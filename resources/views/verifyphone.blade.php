    ...
    <div class="row">
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            ...
            <div class="card card-signin my-5">
                <div class="card-body">
                    <h5 class="card-title text-center" style="font-family: Yekan;font-size: 28px;font-weight: normal">تایید شماره تلفن همراه</h5>
                    <hr>
                    <p style="text-align: right">کد تایید به شماره ی : {{$phone}} ارسال شد </p>
                    ...
                    @if(session('errs'))
                        ...
                        <br>
                    @endif
                    <form method="POST" action="<?php echo route('phoneverification.notice')?>">
                        @csrf
                        <div class="form-label-group">
                            <input type="text" id="username" name="username" class="form-control" placeholder="کد تایید" required autofocus style="text-align: right">
                            <label  for="username" :value="__('username')" style="text-align: right">کد تایید</label>
                        </div>
                        <button class="btn btn-lg btn-block text-uppercase" type="submit" id="subid">ارسال کد تایید</button>
                        <hr>
                    </form>
                    <form method="get" action="<?php echo route('changephone')?>">
                        @csrf
                    <button class="btn btn-lg btn-block text-uppercase" type="submit" id="subid">تعویض شماره تلفن</button>
                    </form>
                    <hr>
                    <form method="post" action="<?php echo route('resend')?>">
                        @csrf
                        <button class="btn btn-lg btn-block text-uppercase" type="submit" id="subid">ارسال دوباره</button>
                    </form>
                </div>
            </div>
        </div>
